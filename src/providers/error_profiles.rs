            ...
            ErrorProfile {
                ...
                patterns: vec![
                    ErrorPagePattern {
                        ...
                        status_codes: vec![403],
                        body_markers: vec!["access denied".to_string(), "reference #".to_string()],
                        header_markers: vec![],
                        confidence: 0.85,
            ...
            for pattern in &profile.patterns {
                ...
                let header_match = if pattern.header_markers.is_empty() {
                    ...
                    pattern
                        .header_markers
                        .iter()
                        .any(|(header_name, substring)| {
                            if let Some(header_value) =
                                headers_lower.get(&header_name.to_lowercase())
                            {
                ...
                evidence.push(Evidence {
                    ...
                    raw_data: format!("status={}, markers={:?}", status_code, pattern.body_markers),
